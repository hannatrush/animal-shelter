            ...
            <div className='volunteer-container'>
                <div className="volunteer-box">
                    ...
                    <div className='be-volunteer'>
                        <p>
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Eius tempore perspiciatis, non laborum illum sapiente ut. Ullam sunt accusamus voluptatem laborum, laudantium natus iste possimus repellat deleniti in ab doloribus? 
                        </p>
                        <div> Volunteer time:</div>
                        <p> Every day <br/> 9 - 12 AM <br/> 4 - 7 PM </p>
                        <div>To become a volunteer please <Link className='contact-us-link' to="/contacts">contact us</Link></div>
                    </div>
                </div>
            </div>
            <Donation/>
